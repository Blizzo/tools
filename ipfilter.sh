...
echo "pass in quick proto tcp from any to any port = 80 keep state" >> $file
echo "pass out quick proto tcp from any to any port = 80 keep state" >> $file
echo "pass in quick proto tcp from any to any port = 443 keep state" >> $file
echo "pass out quick proto tcp from any to any port = 443 keep state" >> $file
